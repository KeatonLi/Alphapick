...
class GenerationTask(Base):
    ...
    step_label: Mapped[str | None] = mapped_column(String(200), nullable=True, comment="当前步骤描述")
    progress_pct: Mapped[int] = mapped_column(Integer, default=0, comment="进度百分比 0-100")
    candidate_stocks: Mapped[str | None] = mapped_column(Text, nullable=True, comment="候选股票 JSON，用于前端展示")
    result: Mapped[str | None] = mapped_column(Text, nullable=True, comment="生成结果 JSON")
